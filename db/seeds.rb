...
Smash = Game.create(title: "Super Smash Bros. Melee", genre: "Fighter", platform: "Nintendo GameCube", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
BotW = Game.create(title: "The Legend of Zelda: Breath of the Wild", genre: "Action/Adventure", platform: "Nintendo Switch", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
FF7 = Game.create(title: "Final Fantasy 7 Remake", genre: "JRPG", platform: "PS4/PS5", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
Halo = Game.create(title: "Halo Infinite", genre: "FPS", platform: "Xbox One/Series X, PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
Crash = Game.create(title: "Crash Bandicoot N. Sane Trilogy", genre: "Platform", platform: "PS4, Xbox One, PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
Mario = Game.create(title: "Super Mario Odyssey", genre: "Platform", platform: "Nintendo Switch", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
RE8 = Game.create(title: "Resident Evil Village", genre: "Survival Horror", platform: "PS4/PS5, Xbox One/Series X, PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
TLOU2 = Game.create(title: "The Last of Us Part II", genre: "Action/Adventure", platform: "PS4", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
...
Forza = Game.create(title: "Forza Horizon 5", genre: "Racing", platform: "Xbox One/Series X, PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
SV = Game.create(title: "Stardew Valley", genre: "Farming Sim", platform: "PS4, Xbox One, Switch, PC, Mobile", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
MC = Game.create(title: "Minecraft", genre: "Survival", platform: "PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
ACNH = Game.create(title: "Animal Crossing: New Horizons", genre: "Life Sim", platform: "Nintendo Switch", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
Hades = Game.create(title: "Hades", genre: "Action Roguelite", platform: "PS4/PS5, Xbox One/Series X, Switch, PC", image_url: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.jpg")
